...
imgDict = {}
# the function to store and display the gif pictures
def getImgWidget(filePath):

    global imgDict

    if os.path.exists(filePath) and os.path.isfile(filePath):
        # if the picture already exists
...
def game_loop():
    ...
    if flag:
        ...
        gameover_photo = getImgWidget("gameover.gif")
...
def introduction():
    ...
    Label(intro, text="Press 'b' to hide the window for 3 secs").grid(row=3, column=0, padx=10, pady=5)
